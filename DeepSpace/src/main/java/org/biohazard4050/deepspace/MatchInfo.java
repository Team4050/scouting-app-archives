...
public class MatchInfo extends AppCompatActivity {
    ...
    public void onButtonClicked(View view) {
        ...
        if (validationError) {
            ...
            Intent theIntent = new Intent(this, Sandstorm.class);
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.robotNearRadioButton:
                ...
                break;
            case R.id.habLevel1RadioButton:
                if (isChecked) {
                    habitatLevel = ScoutingData.HABITAT_LEVEL_1;
                    if (!levelSelected) {
                        levelSelected = true;
                        ((TextView) findViewById(R.id.habLevelTextView)).setTextColor(COLOR_PRIMARY_DARK);
                    }
                }
                break;
            case R.id.habLevel2RadioButton:
                if (isChecked) {
                    habitatLevel = ScoutingData.HABITAT_LEVEL_2;
                    if (!levelSelected) {
                        levelSelected = true;
                        ((TextView) findViewById(R.id.habLevelTextView)).setTextColor(COLOR_PRIMARY_DARK);
                    }
    ...
    private void writeToDB() {
        ...
        values.put(ScoutingData.COLUMN_INFO_START_HAB_LEVEL, habitatLevel);
